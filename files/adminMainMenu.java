...
public class adminMainMenu extends JFrame {
    private JButton viewDetailsButton, logoutButton, withdrawButton, depositButton, internalButton, externalButton, viewTransactionButton;
    ...
    public adminMainMenu(String loggedInUsername, String adminUsername) {
        ...
        logoutButton.setBounds(50, 330, 200, 30);
        add(logoutButton);
